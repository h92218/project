...
<script type="text/javascript">
    ...
    <div class="nav-wrapper light-green">
      <a href="${pageContext.request.contextPath}/main/mobileMain.do" class="brand-logo center" >++ CLUB</a>
    ...
    <div class="nav-content light-green darken-2 center">
      <ul class="tabs tabs-transparent"> 
        <li class="tab"><a href="${pageContext.request.contextPath}/main/mobileMain.do">홈</a></li>
